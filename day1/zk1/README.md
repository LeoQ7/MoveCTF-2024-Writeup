...
fn main() {
    ...
    // Insert our secret inputs as key value pairs. Factor using factordb
    let mut builder = CircomBuilder::new(cfg);
    builder.push_input("a", 220122856615939128826465496588575706951u128);
    builder.push_input("b", 266065903944670592863269285122828789393u128);
